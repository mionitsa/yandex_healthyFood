...
def handle_dialog(req, res):
    ...
    if 'бмж' in req['request']['original_utterance'].lower():
        ...
        '• Белки - cтроительный материал организма, причём не только для клеток, но и для ферментов и гормонов. Белки бывают животными (постное мясо, рыба, ' \
        ...
        '• Углеводы - главный поставщик энерги, сюда входят также клетчатка, витамины и минералы. Они часто сконцентрированы в богатых углеводами продуктах. ' \
