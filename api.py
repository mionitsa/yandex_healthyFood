...
def handle_dialog(req, res):
    ...
    if 'бмж' in req['request']['original_utterance'].lower():
        res['response']['text'] = '• Жиры помогают усваивать витамины А, D и Е. Жирные кислоты делятся на три ' \
        'группы: насыщенные, ненасыщенные и трансжиры. Насыщенные жиры не навредят вам, если не превышать свою норму калорий. А вот трансжиров стоит избегать они увеличивают ' \
        ...
        '• Углеводы - главный поставщик энергии. Углеводосодержащая пища должна составлять основу рациона — 50%. Пусть вас не смущает эта цифра: сюда входят также клетчатка, витамины и минералы. Они часто сконцентрированы в богатых углеводами продуктах. ' \
        'Углеводы делятся на простые (или быстрые) и сложные (медленные). Последние долго расщепляются и дают продолжительный заряд энергии. Простые углеводы быстро усваиваются и дают мгновенный приток энергии.'
        return
    #Факт
